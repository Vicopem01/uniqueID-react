    ...
    return(
        ...
        <div className={classes.mainBox}>
            ...
            <div className={classes.profileDiv}>
                ...
                <br/>
                <input placeholder="......" type="email" className={classes.inputField}/> <br/>
                <input placeholder="Enter new password" type="email" className={classes.inputField}/> <br/>
                <input placeholder="Re-enter password" type="email" className={classes.inputField}/> <br/>
